...
面向大众健身用户的微信小程序，提供运动计划制定、训练记录、身体数据追踪、社区互动等功能，帮助用户科学健身、养成运动习惯。
...
| 功能 | 说明 | 优先级 |
|------|------|--------|
| 微信一键登录 | 基于 wx.login 获取 openid | P0 |
| 个人信息设置 | 性别、年龄、身高、体重、健身目标 | P0 |
| 个人主页 | 训练统计、成就徽章、历史记录入口 | P1 |
| 身体数据档案 | BMI 自动计算、目标体重设定 | P1 |
...
| 功能 | 说明 | 优先级 |
|------|------|--------|
| 计划推荐 | 根据用户目标/水平推荐训练计划 | P0 |
| 自定义计划 | 用户自主创建训练计划 | P0 |
| 计划详情 | 展示每日训练动作、组数、次数 | P0 |
| 计划切换/暂停 | 支持切换计划或暂停当前计划 | P1 |
| 计划日历视图 | 日历形式展示本周/本月计划安排 | P1 |
...
| 功能 | 说明 | 优先级 |
|------|------|--------|
| 体重记录 | 每日记录体重，支持趋势图 | P0 |
| 体脂率记录 | 记录体脂百分比 | P1 |
| 体围记录 | 胸围/腰围/臀围/臂围/腿围 | P1 |
| 数据图表 | 折线图、趋势对比 | P0 |
| 里程碑 | 达成目标时自动标记 | P2 |
